...
const Testimonials = () => {
  return (
    <section className="background_testimonials text-gray-700 pb-20">
  ...
  <div className="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
    <div className="mb-12 md:mb-0">
      ...
      <h5 className="text-xl font-semibold mb-4 text-white">Miguel Duminguesh</h5>
    ...
    <div className="mb-12 md:mb-0">
      ...
      <h5 className="text-xl font-semibold mb-4 text-white">Joan Gao</h5>
      <p className="mb-4 text-white">
        <svg
          aria-hidden="true"
          focusable="false"
    ...
    <div className="mb-0">
      ...
      <h5 className="text-xl font-semibold mb-4 text-white">John Smith</h5>
      <p className="mb-4 text-white">
        <svg
          aria-hidden="true"
          focusable="false"
