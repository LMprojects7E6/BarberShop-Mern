    ...
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style={{maxWidth:"1000px"}}>
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 h-80">
              <img src={require("../../assets/img/LoginAndRegister/img_register.webp")} />
            </div>
                ...
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="text-s font-semibold px-1">First name</label>
                            <div class="flex">
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="text-s font-semibold px-1">Last name</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <label for="" class="text-s font-semibold px-1">Email</label>
                            <div class="flex">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-10">
                            <label for="" class="text-s font-semibold px-1">Confirm Password</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                <input type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" />
                            </div>
