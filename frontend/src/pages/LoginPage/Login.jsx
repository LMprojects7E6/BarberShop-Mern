        ...
        <div className="md:flex w-full">
            ...
            <div className='w-100 justify-center'>
                ...
                <div className="text-center mb-10">
                    <h1 className="font-bold text-3xl text-gray-900">BARBER SHOP</h1>
                    <p>Please login your account</p>
                </div>
                <div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                        <label for="" className="text-s font-semibold px-1">Username</label>
                            <div className="flex">
                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i className="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Username" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5">
                            <label for="" className="text-s font-semibold px-1">Password</label>
                            <div className="flex">
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-5 text-center">
                            <button className="block mb-2 w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">LOG IN</button>
